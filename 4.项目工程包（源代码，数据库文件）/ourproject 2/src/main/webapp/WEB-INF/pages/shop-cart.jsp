<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.List,java.util.ArrayList,com.chinasofti.ssm.vo.CartProduct" %>
        ...
        <div class="container">
          <div class="row">
            <div class="header-1-inner">
              <a class="brand-logo animsition-link" href="index.jsp">
                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail">
                      <img src="${CartProduct.pro_image}" alt="product-thumbnail" text-align:left height="135" width="135">
                    </td>
                    <td class="product-name">
                    	<a class="product-name" >${CartProduct.pro_name}</a>
                    </td>
                    <td class="product-weight" data-title="Weight">0.5 kg</td>
                    <td class="product-quantity" data-title="Quantity">
                      <input id="Quantity" class="qty" min="0" max="" name="product-name" value="${CartProduct.amount}" title="Qty" size="4" pattern="[0-9]*" inputmode="numeric" type="number">
                    </td>
                    <td class="product-price" data-title="Price" id="Price">${CartProduct.pro_price}</td>
                    <td class="product-subtotal" data-title="Total" id="Total">${CartProduct.amount*CartProduct.pro_price}</td>
                    <td class="product-remove">
                      <a href="CartDelete?name=${CartProduct.pro_name}">×</a>
                    </td>
                  </tr>
                </tbody>
                </c:forEach>
                    ...
                    <td colspan="7">
                      <div class="form-coupon organic-form">
                        ...
                        <div class="form-group update-cart">
                          <button class="btn btn-brand-ghost pill" onclick="return fun()">UPDATE CART</button>
                        </div>
                      </div>
                    </td>
                  </tr>
