            ...
            <div class="row main">
              <div class="col-md-6">
                <div class="woocommerce-product-gallery">
                  ...
                  <div class="item">
                      <img class="img-responsive" src="${pro_image}" alt="product thumbnail">
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="summary">
                  <div class="desc">
                    <div class="header-desc">
                      <h2 class="product-title">${pro_info}</h2>
                      <p class="price">${pro_price}</p>
                    </div>
                    <div class="body-desc">
                      <div class="woocommerce-product-details-short-description">
                        <p>在这里您可以看到商品的大图，并且可以分享到自己的社交软件上。下面是我们为本商品加上的标签，您可以点击相关标签查看更多类似商品
                           下方是细节、额外信息和用户评论。
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="product-meta">
                    ...
                    <p class="tagged-as">Tags:
                      <a href="shop" rel="tag">Natural</a>,
                      <a href="shop" rel="tag">Organic</a>,
                      <a href="shop" rel="tag">Health</a>,
                      <a href="shop" rel="tag">Green</a>,
                      <a href="shop" rel="tag">Vegetable</a>
                    </p>
                    <p class="id">
                    </p>
                  </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="tab-content tab-content-style-1">
                  ...
                  <div class="tab-pane fade" id="Review" role="tabpanel">
                    <h3 class="title-tab">reviews for this product</h3>
              ...
              <div class="col-md-6">
                <ul class="tabs tab-style-1" role="tablist">
                  ...
                  <div>
                      <input type="text" name="review" placeholder="just input" style="width:450px;" />
